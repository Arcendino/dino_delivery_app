...
import 'package:dino_delivery_demo/screens/loginScreen.dart';
      ...
      child: Stack(
        children: [
          ...
          Align(
            ...
            child: Image.asset(
              Helper.getAssetName("dinologo.png", "virtual"),
            ),
          ),
          Align(
            ...
            child: Container(
              ...
              child: Column(
                children: [
                  Flexible(
                    child: Text(
                      "Descubra as melhores refeições em mais de 1.000 restaurantes e entrega rápida.",
